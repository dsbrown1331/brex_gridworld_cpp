...
//Code to run experiment to compare Bayesian REX with suboptimal ranked demos with Bayesian IRL with optimal demos
...
int main() 
{
    ...
    const vector<unsigned int> numDemos = {2,5,10,20,30};            //number of demos to give
...
//    double** stateFeatures = random9x9GridNavGoalWorld8Features();
    ...
    string filePath = "./data/brex_gridworld_optsubopt/";
